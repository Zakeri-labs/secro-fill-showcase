...
const ar: Dict = {
  ...
  "services.sub":
    "تركيبات حمض هيالورونيك متشابك مصممة لنحت الوجه وزيادة حجم الجسم.",
  ...
  "services.p3.name": "SECRO-FILL BODY FILLER",
  "services.p3.desc":
    "مصمم لزيادة حجم الجسم بمصفوفة جل عالية الكثافة لنتائج انسيابية وطبيعية.",
  ...
  "about.c1.desc":
    "أبحاث تشابك خاصة تنتج جل حمض هيالورونيك نقي ومستقر بسلوك سريري متوقع.",
  ...
  "about.c3.desc":
    "نموذج شراكة للعيادات والأطباء والموزعين مع تدريب ووثائق وتوريد موثوق.",

  "portfolio.eyebrow": "دليل العمل",
  "portfolio.title": "معرض قبل وبعد",
  "portfolio.sub":
    "توثيق تمثيلي لنتائج نحت الوجه وتحويل الجسم. استبدل هذه الصور بصور عيادتك.",
...
const fa: Dict = {
  ...
  "services.p3.name": "SECRO-FILL BODY FILLER",
  "services.p3.desc":
    "طراحی‌شده برای حجم‌دهی بدن با ماتریس ژل پرتراکم و نتیجه‌ای یکدست و طبیعی.",
  ...
  "process.s1.desc": "بازار، پروفایل بالینی و حجم مورد انتظار شما را در مشاوره‌ای خصوصی بررسی می‌کنیم.",
